  ...
  return (
    <section id="home" className="min-h-screen top-2 items-center justify-center px-4 relative">
      ...
      <div className="text-center px-4 py-4 bg-gray-10 border-2">
        <h1 className="text-2xl md:text-7xl mb-6 bg-gradient-to-r py-6 from-rose-400 to-orange-600 bg-clip-text text-transparent leading-right">
          Quality, Homemade Jerky
        </h1>
        <p className="text-gray-400 text-lg font-bold mb-8 max-w-lg mx-auto">
      ...
      <div className="min-h-screen flex flex-col items-center mt-24 md:px-32 px-5">
        <h2 className="text-5xl font-bold mb-3 bg-gradient-to-r from-orange-600 to-rose-400 bg-clip-text text-transparent text-center">
          Explore Flavors
        </h2>
